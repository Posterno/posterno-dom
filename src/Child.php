...
class Child extends AbstractNode {
	 ...
	 *
	 * @param  boolean $ignoreWhiteSpace yes or no.
	 * @return string
	 */
	 ...
	 *
	 * @param  array $a attributes to add.
	 * @return Child
	 */
	 ...
	 *
	 * @param  string $name attribute to verify.
	 * @return boolean
	 */
	 ...
	 *
	 * @param  string $a attribute to remove.
	 * @return Child
	 */
	 ...
	 *
	 * @param  int     $depth number.
	 * @param  string  $indent indentation value.
	 * @param  boolean $inner yes or no.
	 * @return mixed
	 */
